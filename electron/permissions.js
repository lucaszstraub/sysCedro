...
const CHANNEL_PERMISSIONS = {
  ...
  'estoque:localizacoesProduto': PERMISSIONS.WMS,
  ...
  'entregas:confirmarAgendamento': PERMISSIONS.WMS,
  ...
  'produtos:etiqueta': PERMISSIONS.CADASTROS,
  'etiquetas:recebimentos': PERMISSIONS.WMS,
  'etiquetas:imprimir': PERMISSIONS.WMS,
...
const SHARED_CHANNELS = {
  ...
  'clientes:create': [PERMISSIONS.VENDAS, PERMISSIONS.PLANEJADOS, PERMISSIONS.GERENCIAL, PERMISSIONS.CADASTROS],
  'clientes:update': [PERMISSIONS.VENDAS, PERMISSIONS.PLANEJADOS, PERMISSIONS.GERENCIAL, PERMISSIONS.CADASTROS],
  'fornecedores:list': [
    PERMISSIONS.CADASTROS,
    PERMISSIONS.GERENCIAL,
    PERMISSIONS.WMS,
  ...
  'produtos:etiqueta': [PERMISSIONS.CADASTROS, PERMISSIONS.VENDAS, PERMISSIONS.WMS],
  'etiquetas:recebimentos': [PERMISSIONS.WMS, PERMISSIONS.CADASTROS, PERMISSIONS.VENDAS],
  'etiquetas:imprimir': [PERMISSIONS.WMS, PERMISSIONS.CADASTROS, PERMISSIONS.VENDAS],
